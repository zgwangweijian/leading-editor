...
(function () {
    CKEDITOR.dialog.add('link', function (editor) {
        ...
        var uploadUrl = editor.config.filebrowserImageUploadUrl || editor.config.filebrowserUploadUrl,
            downloadUrl = editor.config.filebrowserImageDownloadUrl || editor.config.filebrowserDownloadUrl;
        ...
        var setFileInfo = function (fileInfo, that) {
            ...
            dialog.getContentElement("info", "linkDisplayText").setValue(fileInfo.fileName);
            dialog.getContentElement("info", "linkType").setValue("url");
            dialog.getContentElement("info", "url").setValue(href);
                            ...
                            onClick: function () {
                                ...
                                ajax.onload = function () {
                                    ...
                                    if (result && "success" === result.status) {
                                        var fileInfo = (result.data && result.data.length) ? result.data[0] : result.data;
                                        setFileInfo(fileInfo, that);
                                    }
                                };
                                ajax.send(fd);
                            }
